...
from torchvision.models import (RegNet_Y_16GF_Weights, ResNet50_Weights,
                                Swin_T_Weights, ViT_B_16_Weights)

from openood.evaluation_api import Evaluator
from openood.networks import RegNet_Y_16GF, ResNet50, Swin_T, ViT_B_16
...
evaluator = Evaluator(
    net,
    id_name=args.dataname,  # the target ID dataset
